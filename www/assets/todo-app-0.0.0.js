/**
 * todo-app - v0.0.0 -  2015-04-27
 * https://github.com/rubensdev/todo-app
 **//**
...
angular.module('app', [
  ...
  'tasksStorage',
  '$location',
  function ($rootScope, tasksStorage, $location) {
...
angular.module('config', ['pascalprecht.translate']).constant('COLORS', function () {
  var Colors = function () {
    this.codes = [
      [
        'ALIZARIN',
  ...
  function ($translateProvider) {
    $translateProvider.translations('en', {
      ...
      ADDINGTASK_MSG: 'Este bot\xf3n hace magia. Cuando lo presiones, aparecer\xe1 un panel (es intuitivo, no te preocupes)',
      ADDINGTASK_TITLE: 'A\xf1adiendo tareas',
      ACTIVETASKS: 'Activas',
      ALLTASKS: 'Todas',
      CANCEL_BTN: 'Cancelar',
      COMPLETEDTASKS: 'Completadas',
      EDIT_BTN: 'Editar',
      MODDELRESET_ENJOY: '\xa1Eso es todo, espero que la disfrutes!',
      MODDELRESET_MSG1: 'Si tocas una tarea, aparecer\xe1 un men\xfa con dos opciones: editar y borrar.',
      MODDELRESET_MSG2: 'Para reiniciar la aplicaci\xf3n, a\xf1ade una tarea con la palabra <h2>"Rayuela"</h2>',
      MODDELRESET_TITLE: 'Modificar o borrar tareas y reiniciar la aplicaci\xf3n',
      NEXT_BUTTON: 'Siguiente',
      NEXT_GO: 'Ok,\xa1vamos!',
      SUBMIT_BTN: 'Aceptar',
      TASKCOLOR_TITLE: 'Color de la tarea',
      TEXTAREA_PH: 'Mmm... \xbfQu\xe9 hay que hacer?',
      WELCOME_APP: 'Bienvenido a la aplicaci\xf3n. Toca el bot\xf3n Siguiente.'
    });
  }
]).run([
  '$translate',
